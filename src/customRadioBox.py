...
class CustomRadioButton(wx.Control):    
    ...
    def __init__(self, parent, id=wx.ID_ANY, label:str="",
                 value:bool=False, pos=wx.DefaultPosition,
                 size=wx.DefaultSize, style=wx.NO_BORDER,
                 validator=wx.DefaultValidator,
                 name="CustomRadioButton", theme:str="lightTheme",
                 fontSize=8, faceName="Verdana", referenceBox=wx.Control):
...
class CustomRadioBox(wx.Control):
    """ Defines a custom radiobox control that supports themes. """
    
    def __init__(self, parent, id=wx.ID_ANY, labels:list=[],
                 value:str="", pos=wx.DefaultPosition,
                 size=wx.DefaultSize, style=wx.NO_BORDER,
                 validator=wx.DefaultValidator,
                 name="CustomRadioButton", theme:str="lightTheme",
        ...
        """ The control will contain a raduibutton for each label in
        the labels list. If a value is specified (a label from the
        list), that radiobutton will be selected."""
        ...
        self._SeparationVertical = dip(5)
    ...
    def SetLabelList(self, labels:list) -> None:
        """ Sets the radiobuttons in the control. """
        self._Labels = labels
        self.Refresh()
